...
const App= ()=> {
  ...
  const win = (c)=>{
    let newtext = `Dordle ${curref.current[0]+1}/6\n\n`;
    ...
    <div className="wordle">
          ...
          <DialogContent className="status" >
            ...
            <div className='statusbuttons' >
              ...
              <Button variant="contained" href="https://resume.creddle.io/resume/tkm4ow6uha" target="_blank" color="secondary" size="large" >My Resume</Button>
            </div>
        ...
        <div className="bar">
          ...
          <div className="title">
            <div className="title1">DORDLE</div>
          </div>
